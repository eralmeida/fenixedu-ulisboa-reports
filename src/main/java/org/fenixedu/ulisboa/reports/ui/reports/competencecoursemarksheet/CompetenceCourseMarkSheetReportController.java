...
@SpringFunctionality(app = FenixeduULisboaReportsController.class,
                     title = "label.org.fenixedu.ulisboa.reports.title.competenceCourseMarkSheet",
                     accessGroup = "logged")
...
public class CompetenceCourseMarkSheetReportController extends FenixeduULisboaReportsBaseController {
    ...
    static private String getReportId(final String exportName) {
        return normalizeName(bundle("marksheet.event." + exportName), "_") + "_UUID_" + UUID.randomUUID().toString();
    }
    ...
    public String search(@RequestParam(
            "bean") CompetenceCourseMarkSheetReportParametersBean bean, Model model,
    ...
    public @ResponseBody ResponseEntity<String> exportReport(@RequestParam(value = "bean",
                                                                           required = false) final CompetenceCourseMarkSheetReportParametersBean bean,
                                                             final Model model) {
    ...
    @RequestMapping(value = "/exportstatus/{reportId}", method = RequestMethod.GET,
                    produces = "text/plain;charset=UTF-8")
    public @ResponseBody ResponseEntity<String> exportStatus(@PathVariable(
            value = "reportId") final String reportId, final Model model) {
    ...
    public void downloadReport(@PathVariable(
            "reportId") String reportId, final Model model, RedirectAttributes redirectAttributes,
    ...
    private byte[] exportToXLS(final CompetenceCourseMarkSheetReportParametersBean bean) {
        ...
        builder.addSheet(bundle("competenceCourseMarkSheet.competenceCourseMarkSheet"), new SheetData<CompetenceCourseMarkSheetReport>(toExport) {
            ...
            private void addCompetenceCourseMarkSheetData(final CompetenceCourseMarkSheetReport report) {
                addData("CompetenceCourseMarkSheetReport.courseCode", report.getComptenceCourseName());
                addData("CompetenceCourseMarkSheetReport.courseName", report.getCompetenceCourseCode());
    ...
    public @ResponseBody ResponseEntity<String> postback(
            @RequestParam(value = "bean",
                          required = false) final CompetenceCourseMarkSheetReportParametersBean bean, final Model model) {
