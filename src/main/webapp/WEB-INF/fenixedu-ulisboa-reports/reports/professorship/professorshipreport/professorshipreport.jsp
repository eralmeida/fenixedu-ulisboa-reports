        ...
        <div class="panel-body">
            ...
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message
                            code="label.org.fenixedu.ulisboa.reports.ProfessorshipReportParametersBean.executionYear"/>
                </div>
                <div class="col-sm-6">
...
<table id="resultsTable" class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <th><spring:message code="label.org.fenixedu.ulisboa.reports.ProfessorshipDegreeReport.degree"/></th>
        <th><spring:message code="label.org.fenixedu.ulisboa.reports.ProfessorshipDegreeReport.degreeCode"/></th>
